...
export default function Projects() {
  ...
  {
    title: "PakThekedaar",
    desc: "A scalable B2B marketplace connecting buyers and suppliers of construction materials with seamless product discovery, order management, and real-time business interactions.",
  ...
  {
    title: "ReveloVox",
    desc: "An AI-powered voice analysis application that detects stress levels from speech using Google's Gemini AI and provides personalized wellness insights with secure cloud-based data management.",
    tags: ["React Native", "Gemini AI", "Firebase", "JavaScript"],
    link: "https://play.google.com/store/apps/details?id=com.stresschecker",
    image: reveloVoxImg,
  },
  {
    title: "See",
    desc: "An accessibility-focused Android application that enhances screen readability through intelligent font scaling, adaptive brightness, dark mode optimization, and personalized vision accessibility settings.",
